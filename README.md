...
Define a method named `list_artists`. This method should use the `each_key` method to iterate over the hash and print out the artists (the keys) in the library. This method should accept a hash as an argument.
